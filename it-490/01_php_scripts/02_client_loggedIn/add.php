...
<form action="../RabbitMQClientSample.php">
	...
	<div class="form-group">
			...
			<div class="form-group">
			<label for="queueduration">QueDuration</label>
			<input type="text" name="queueduration" class="form-control" id="queueduration">
	</div>
	<input type="submit" name="type" value="Qadd_client" class="btn btn-default"></input>
</form>	
